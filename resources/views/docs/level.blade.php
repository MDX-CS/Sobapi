...
@section('name', 'Level Resource&mdash;Documentation')
...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="row">
                @include('docs.partials.side-menu', ['current' => 'level'])

                <div class="col-md-8 col-md-offset-1 documentation">
                    <h1>Level resource</h1>
                    ...
                    <p>You can view the list of all levels by sending a <code>GET|HEAD</code> request to the <code>api/levels</code> uri. If you want to request just a specific level, send a <code>GET|HEAD</code> request to <code>api/levels/{level}</code>, replacing the <code>level</code> wildcard with its <code>id</code>. You do not need any special authorization to perform this action, apart from having a valid access token.</p>
                    ...
                    <snippet>
{
    "data": {
        ...
        "name": "Threshold"
                    ...
                    <p>You are allowed to add new levels by sending a <code>POST</code> requiest to the <code>api/levels</code> uri. <strong>Note, however, that you need to be authorized to manage levels to perform this action.</strong></p>
                    ...
                    <p>You can edit levels by sending a <code>PUT|PATCH</code> request to the <code>api/levels/{level}</code> uri. The <code>level</code> wildcard stands for the entry <code>id</code> <strong>Note, however, that you need to be authorized to manage levels to perform this action.</strong></p>
                    ...
                    <p>Upon sending a <code>DELETE</code> request to the <code>api/levels/{level}</code> uri, you will delete the <code>level</code> under provided <code>id</code>. <strong>Note, however, that you need to be authorized to manage levels to perform this action.</strong></p>
